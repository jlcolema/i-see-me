...
function cartTestTracking() {
  ...
  var gaTracking = setInterval(function () {
    ...
    if (typeof (ga) !== 'undefined') {
      ...
      ga('cartTracking.set', 'dimension3', 'VWO-149 Combination 4');
      ga('cartTracking.send', 'event', 'VWO', 'VWO-149', 'Combination 4', { nonInteraction: 1 });
...
var onDocumentLoad = function () {
  ...
  // Add `.cart-collapse-test` and `cart-collapse-test--4` to the `body`.
  document.body.classList.add("cart-collapse-test", "cart-collapse-test--4");
...
try {
  ...
  var e = {
    dev: 'U05C4LLSK6G',
    vwotest: '149',
    vwodesc: 'ISM-A-Cart-CollapsePersonalizeDetails-V1-Jun2023 | Combination 4',
    type: 'vwo',
